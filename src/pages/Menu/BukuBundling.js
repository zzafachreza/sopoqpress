...
export default function PaketBundling({navigation, route}) {
  const product = {
    judul: 'Paket Bundling (Naskah + Terbit)',
    harga: 5000000,
  };
  ...
  return (
    <View style={styles.container}>
      <MyHeader
        title="Paket Bundling (Naskah + Terbit)"
        onPress={() => navigation.goBack()}
      />
